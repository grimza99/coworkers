...
export default function DeleteAccountFailModal() {
  const { closeModal } = useModalContext();

  return (
    <>
      <ModalPortal modalId="delete-account-fail">
        <ModalOverlay modalId="delete-account-fail">
            ...
            <ModalFooter className="w-full">
              <div className="flex w-full gap-2">
                <Button
                  ...
                  className="w-full"
                  size="fullWidth"
                  onClick={() => closeModal('delete-account-fail')}
                >
                  다시 시도하기
                </Button>
              </div>
